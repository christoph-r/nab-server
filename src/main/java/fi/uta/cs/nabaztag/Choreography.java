...
public class Choreography {
	...
	private final int[] lastBytes = new int[] { 0, 0, 0, 0 };
	...
	/**
	 * Changes led to some value For example to change top led to bright red addLedCommand(20, Choreography.LED_TOP, 255, 0, 0)
	 * 
	 * @param time
	 *            at tempo beat number
	 * @param led
	 *            led color to set
	 * @param r
	 *            red value of led (0-255)
	 * @param g
	 *            green value of led (0-255)
	 * @param b
	 *            blue value of led (0-255)
	 */
	...
	/**
	 * Moves ear to some position Example: addEarCommand(30, Cheography.EAR_RIGHT, 5, Cheography.DIRECTION_FORWARD);
	 * 
	 * @param time
	 *            at tempo beat number
	 * @param ear
	...
	/**
	 * Creates four byte long version of int Command
	 * 
	 * @param value
	 * @return
	 */
